                ...
                <div class="card-body">
                  <form action="reg.php" method="POST" id="contact__form2" class="contact__form">
					<div class="input-group form-group">
						...
						<input type="text" class="form-control" placeholder="First Name" name="reg_fname" required>
					...
					<div class="input-group form-group">
						...
						<input type="text" class="form-control" placeholder="Last Name" name="reg_lname" required>
					</div>
					...
					<div class="input-group form-group">
						...
						<input type="password" class="form-control" placeholder="re-password" name="reg_re-password" required>
					</div>
