...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2020 at 11:00 AM
...
INSERT INTO `papers` (`grade`, `subject`, `paper`, `file`) VALUES
('10', 'science', '2017', 'science_10_2017.pdf');
...
INSERT INTO `user` (`id`, `fname`, `lname`, `email`, `password`, `user_role`) VALUES
...
--
ALTER TABLE `papers`
  ADD PRIMARY KEY (`grade`,`subject`,`paper`);
